...
export function Footer() {
  ...
  return (
    <footer className="bg-beige-light border-t border-beige">
      <Container>
        <div className="py-12 lg:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {/* Services */}
            <div>
              <h3 className="text-sm font-semibold text-sage uppercase tracking-wider mb-4">
                Serviços
              </h3>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-600">
                <li>
                  <a
                    href="https://wa.me/5562981260247"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="mt-12 pt-8 border-t border-beige">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <p className="text-sm text-gray-600">
                &copy; {currentYear} Angela Spa & Estética. Todos os direitos
                reservados.
              </p>
